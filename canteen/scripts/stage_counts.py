...
def main() -> int:
    ...
    rows = {
        ...
        "orders placed tapal (count)": prom(f"sum(increase(canteen_orders_placed_total{{shop='tapal'}}[{w}]))", at),
        ...
        "prep p95 all shops (s)": prom(hq(0.95, "canteen_order_prep_seconds"), at),
    ...
    kql = {
        ...
        'event:"order_placed" and shop:"tapal"': 'event:"order_placed" AND shop:"tapal"',
